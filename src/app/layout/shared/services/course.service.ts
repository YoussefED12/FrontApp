...
export class CourseService {
  ...
  public getinstructorCourses(id: number): Observable<any> {
    return this.http.get(this.BaseUrl + "/training/findTrainingByidInstructor/" + id);
  }
  ...
  public startCourse(id: number) {
    return this.http.get(this.BaseUrl + "/training/startCourse/" + id);
  }

  public delete(id: number): Observable<any> {
    return this.http.get(this.BaseUrl + "/training/delete/" + id);
  }
}
